...
int main(void) {
	...
	try {
		...
		while (!glfwWindowShouldClose(window)) {
			...
			Render(square, textureShader,glm::vec3(-0.5,0,0), scale, orientation, texture1, texture2);
			Render(cube, textureShader, glm::vec3(0.5,0,0), scale*(float)2, orientation, texture2, texture1);
